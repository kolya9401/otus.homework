...
public extension DependencyContainer {
    @MainActor func makeProPlayersListView() -> some View {
        let viewModel = ProPlayersListViewModelImpl(
            reposytory: makeProPlayersListReposytory(),
...
private extension DependencyContainer {
    func makeProPlayersListReposytory() -> ProPlayersListReposytory {
        ProPlayersListReposytoryImpl(
            proPlayerListLocalService: localStorageDependencyContainer.makeProPlayerListLocalService(),
